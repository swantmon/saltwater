...
namespace FutoGCV
{
    ...
    //---Execute Functions---
    void CFGI::WLS_Single(Gfx::CTexturePtr Output_HR, const Gfx::CTexturePtr Input_LR, const Gfx::CTexturePtr Guide_HR)
    {
        // Input_HR_Interpolation = Interpolation(Input_LR)
        // Generate Mask: Mark pixels which is not generated by Interpolation.
        // Input_SparseHR = Input_HR_Interpolation .* Mask
    ...
    void CFGI::FGS(Gfx::CTexturePtr Output_TexturePtr, const Gfx::CTexturePtr Input_TexturePtr, const Gfx::CTexturePtr Guide_TexturePtr)
    {
        ...
        for (int iter = 0; iter < m_Iteration_FGS1; iter++)
        {
            ...
            m_Param_FGS1.m_Direction = glm::ivec2(1, 0); // Horizontal direction
            ...
            m_Param_FGS1.m_Direction = glm::ivec2(0, 1); // Vertical direction
