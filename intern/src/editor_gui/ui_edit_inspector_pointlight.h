...
public:
    ...
    void setupUi(QWidget *InspectorPointlight)
    {
        ...
        InspectorPointlight->resize(354, 348);
        ...
        QWidget::setTabOrder(m_pColorModeCB, m_pPickColorButton);
        QWidget::setTabOrder(m_pPickColorButton, m_pTemperatureEdit);
        QWidget::setTabOrder(m_pTemperatureEdit, m_pIntensityEdit);
        QWidget::setTabOrder(m_pIntensityEdit, m_pDirectionXEdit);
        QWidget::setTabOrder(m_pDirectionXEdit, m_pDirectionYEdit);
        QWidget::setTabOrder(m_pDirectionYEdit, m_pDirectionZEdit);
        QWidget::setTabOrder(m_pDirectionZEdit, m_pAttenuationRadiusEdit);
        QWidget::setTabOrder(m_pAttenuationRadiusEdit, m_pInnerConeAngleEdit);
        QWidget::setTabOrder(m_pInnerConeAngleEdit, m_pOuterConeAngleEdit);
        QWidget::setTabOrder(m_pOuterConeAngleEdit, m_pShadowTypeCB);
        QWidget::setTabOrder(m_pShadowTypeCB, m_pShadowQualityCB);
        QWidget::setTabOrder(m_pShadowQualityCB, m_pShadowRefreshCB);
        QWidget::setTabOrder(m_pShadowRefreshCB, m_pPickColorButton2);
