...
namespace 
{
    ...
    void CGfxSkyManager::RenderSkyboxFromTexture(CInternSky* _pOutput, float _Intensity)
    {
        if (_pOutput->m_InputTexturePtr == 0)
        {
    ...
    void CGfxSkyManager::RenderSkyboxFromGeometry(CInternSky* _pOutput, float _Intensity)
    {
        if(_pOutput->m_InputTexturePtr == 0)
        {
