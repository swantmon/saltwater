...
#include "engine/graphic/gfx_smaa_look_up_textures.h"
...
namespace
{
        ...
        , m_DebugAlbedo                      (false)
    {
		...
		m_ResizeDelegate = Gfx::Main::RegisterResizeHandler(std::bind(&CGfxPostFXRenderer::OnResize, this, std::placeholders::_1, std::placeholders::_2));
    }
