...
namespace Stereo
{
    ...
    public:
        ...
        void imp_PlanarRect(FutoGmtCV &RectImg_Base, FutoGmtCV &RectImg_Match, cv::Mat &Orig2Rect_B_x, cv::Mat &Orig2Rect_B_y, cv::Mat &Orig2Rect_M_x, cv::Mat &Orig2Rect_M_y, const FutoGmtCV &OrigImg_Match);
