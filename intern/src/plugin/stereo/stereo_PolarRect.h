...
namespace Stereo
{
    ...
    private:
        ...
        std::vector<cv::Point2d> m_thetaPoints1, m_thetaPoints2; // Image Points along Epipolar Line.

        cv::Mat m_mapX1, m_mapY1, m_mapX2, m_mapY2; // Look-up Table from Polar to Cartisian.
        cv::Mat m_inverseMapX1, m_inverseMapY1, m_inverseMapX2, m_inverseMapY2; // Look-up Table from Cartisian to Polar.
