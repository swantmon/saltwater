...
namespace ShaderManager
{
    ...
    void ReloadShader(CShaderPtr _ShaderPtr, const Base::Char* _pFileName, const Base::Char* _pShaderName, unsigned int _NumberOfDefines = 0, const Base::Char** _ppShaderDefines = nullptr, const Base::Char* _pShaderDescription = nullptr, unsigned int _Categories = 0, bool _HasAlpha = false, bool _Debug = false);
