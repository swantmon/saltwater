...
namespace Gfx
{
    ...
    void CView::Update()
    {
        ...
        // --------------------------------------------------------------------------------
        m_ViewMatrix[0][0] = XAxis[0]; m_ViewMatrix[0][1] = XAxis[1]; m_ViewMatrix[0][2] = XAxis[2]; m_ViewMatrix[0][3] = -glm::dot(XAxis, m_Position);
        m_ViewMatrix[1][0] = YAxis[0]; m_ViewMatrix[1][1] = YAxis[1]; m_ViewMatrix[1][2] = YAxis[2]; m_ViewMatrix[1][3] = -glm::dot(YAxis, m_Position);
        m_ViewMatrix[2][0] = ZAxis[0]; m_ViewMatrix[2][1] = ZAxis[1]; m_ViewMatrix[2][2] = ZAxis[2]; m_ViewMatrix[2][3] = -glm::dot(ZAxis, m_Position);
