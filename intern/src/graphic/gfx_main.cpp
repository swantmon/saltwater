...
namespace
{
...
#ifdef __ANDROID__
        m_GraphicsInfo.m_MajorVersion = Base::CProgramParameters::GetInstance().GetInt("graphics:api:major:version", 3);
        m_GraphicsInfo.m_MinorVersion = Base::CProgramParameters::GetInstance().GetInt("graphics:api:minor:version", 2);
#else
        m_GraphicsInfo.m_MajorVersion = Base::CProgramParameters::GetInstance().GetInt("graphics:api:major:version", 4);
        m_GraphicsInfo.m_MinorVersion = Base::CProgramParameters::GetInstance().GetInt("graphics:api:minor:version", 5);
#endif

        // -----------------------------------------------------------------------------
        // Load pixel matching behavior
        // -----------------------------------------------------------------------------
        m_GraphicsInfo.m_PixelMatching = static_cast<CInternGraphicsInfo::EPixelMatching>(Base::CProgramParameters::GetInstance().GetInt("graphics:pixel:matching", 0));
    }
    ...
    void CGfxMain::SetWindowSize(SWindowInfo* _pWindowInfo, int _Width, int _Height)
    {
        ...
        {
            float Scale = Base::CProgramParameters::GetInstance().GetFloat("graphics:pixel:matching:scale", 1.0f);
        ...
        {
            _pWindowInfo->m_InternalWindowSize[0] = Base::CProgramParameters::GetInstance().GetUInt("graphics:pixel:matching:w", _Width);
            _pWindowInfo->m_InternalWindowSize[1] = Base::CProgramParameters::GetInstance().GetUInt("graphics:pixel:matching:h", _Height);
        }
        break;
        };
    }
