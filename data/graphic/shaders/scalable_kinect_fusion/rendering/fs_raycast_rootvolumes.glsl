...
#ifndef __INCLUDE_FS_RAYCAST_ROOTVOLUMES_GLSL__
#define __INCLUDE_FS_RAYCAST_ROOTVOLUMES_GLSL__
...
layout(std140, binding = 1) uniform ScalableRaycastConstantBuffer
{
    vec3 g_AABBMin;
    vec3 g_AABBMax;
...
#endif // __INCLUDE_FS_RAYCAST_ROOTVOLUMES_GLSL__