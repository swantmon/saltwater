...
layout (binding = 0, r32f) readonly uniform image2D cs_Disp_RectImg;
layout (binding = 1, r32f) writeonly uniform image2D cs_Depth_RectImg;
...
void main()
{
	...
	float Depth = Disparity == 0.0f ? 0.0f : g_FocalLength * g_BaselineLength / Disparity *1000; // Unit = mini-meter
